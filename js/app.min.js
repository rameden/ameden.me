...
Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var rn=e.jQuery,on=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=on),t&&e.jQuery===ie&&(e.jQuery=rn),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),$(".main-heading").sticky(),$(".main-heading").on("sticky-start",function(){$(this).css({fontSize:"2rem",background:"#ffa949",marginTop:"0",borderBottom:"3px solid black"})}),$(".main-heading").on("sticky-end",function(){$(this).css({fontSize:"5.625rem",background:"transparent",border:"none"})}),console.log("I am the new main.js file!");